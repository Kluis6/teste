...
export function Send(values) {
 ...
 export function warrantyS() {
  const i = document.getElementById('garantia').value;
  if (i == 'veiculo') {
      document.getElementById('parcelas').innerHTML = '<option value="24">24</option> <option value="36">36</option> <option value="48">48</option>';
  } else {
      document.getElementById('parcelas').innerHTML = '<option value="120">120</option> <option value="180">180</option> <option value="240">240</option>';
  }
...
export default class CreditasChallenge {
  ...
  static registerEvents() {
    ...
    handleChangeRangeHomeUnderWarranty(
      document.getElementById('valor-garantia-range'),
      document.getElementById('valor-garantia')
    )

    handleChangeHomeLoanAmount(
      document.getElementById('valor-emprestimo-range'),
      document.getElementById('valor-emprestimo')
    )
  }
